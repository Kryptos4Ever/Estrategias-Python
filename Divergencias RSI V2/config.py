...
RSI_LENGTH = 7       # Período del RSI
N          = 13        # Ventana de búsqueda del extremo local (velas anteriores)
...
#
FLOOR_PCT    = 15     # % del ATH usado como ATL_REF mínimo  (ej: 15 → ratio 6.7x)
FACTOR_CAIDA = 3.5    # Curvatura  (>1 convexo · =1 lineal en log · <1 cóncavo)
